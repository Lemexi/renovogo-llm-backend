...
function postRules({ parsed, trust, evidences, history, userText, sid, evidenceDetails }) {
  ...
  const HESITATION_LINES = [
    'Понимаю, но для меня это пока дорого. Давайте вернёмся к условиям и документам.',
    'Пожалуйста, не давите. Если решу работать с вами — обязательно сообщу. Сейчас хочу ещё раз проверить условия.',
    'У меня пока нет кандидатов. Давайте согласуем формат и подтверждающие документы.',
    'Сейчас занимаюсь подбором персонала под ваши запросы — напишу на следующей неделе. Присылайте контракт и деманд.',
    'Для меня это высоко. Отправьте прозрачную разбивку цены и условия, чтобы я понял, за что плачу.',
    'Готов оплатить после разрешений на работу. Сейчас рисковать такой суммой не хочу — пришлите контракт/деманд для проверки.',
    'Пока не уверен, что хочу работать именно с вами. Давайте начнём с проверки документов и условий сотрудничества.',
    'Сначала хочу увидеть подлинность: деманд/контракт. Потом обсудим оплату.'
  ];
